...
const ItemDatabase = [
    ...
    new Item("Giáo", ItemType.ItemType.SWORD, ItemType.ItemUsageType.EQUIPMENT, 2, "6"),
    ...
    new Item("Khiên", ItemType.ItemType.SWORD, ItemType.ItemUsageType.CONSUMABLE, 3, "6"),
